...
describe('product create ', () => {
    ...
    it('exists after being created', async () => {
        ...
        await productService.create(productTest);
        const createdProductList = await productModel.find();

	console.log(createdProductList);
    });
...
const productTest = {
    name: 'nokia 7.1',
    price: 149,
    description: 'A new nokia with dual‑camera system captures more of what you see and love. '
};
